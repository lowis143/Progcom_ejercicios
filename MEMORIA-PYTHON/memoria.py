...
"""
cuadros = [
    [Cuadro("assets/ferrari.png"), Cuadro("assets/ferrari.png"),
     Cuadro("assets/lambo.png"), Cuadro("assets/lambo.png")],
    [Cuadro("assets/porsche.png"), Cuadro("assets/porsche.png"),
     Cuadro("assets/pagani.png"), Cuadro("assets/pagani.png")],
    [Cuadro("assets/hyundai.png"), Cuadro("assets/hyundai.png"),
     Cuadro("assets/camaro.png"), Cuadro("assets/camaro.png")],
    [Cuadro("assets/audi.png"), Cuadro("assets/audi.png"),
     Cuadro("assets/honda.png"), Cuadro("assets/honda.png")],
]
