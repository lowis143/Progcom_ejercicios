#Link creador 
#https://www.youtube.com/watch?v=eTM2WhUsCVk&t=95s
...
menuBg = pygame.image.load(directory + "\\sprites\\menu.png").convert_alpha()
...
class enemyCar(pygame.sprite.Sprite):
    ...
    def __init__(self, kind, lane):
        ...
        self.image = pygame.transform.rotate(pygame.transform.scale(pygame.image.load(directory + "\\sprites\\car_1.png").convert_alpha(),self.size),180)
        ...
        if self.kind == 1:
            self.image = pygame.image.load(directory + "\\sprites\\car_1.png").convert_alpha()
        elif self.kind == 2:
            self.image = pygame.image.load(directory + "\\sprites\\truck_1.png").convert_alpha()
        elif self.kind == 3:
            self.image = pygame.image.load(directory + "\\sprites\\truck_2.png").convert_alpha()
        elif self.kind == 4:
            self.image = pygame.image.load(directory + "\\sprites\\truck_3.png").convert_alpha()
        elif self.kind == 5:
            self.image = pygame.image.load(directory + "\\sprites\\truck_4.png").convert_alpha()
        elif self.kind == 6:
            self.image = pygame.image.load(directory + "\\sprites\\bus.png").convert_alpha()
...
class thing(pygame.sprite.Sprite):
    ...
    def __init__(self, lane):
        ...
        self.image = pygame.image.load(directory + "\\sprites\\diamante.png").convert_alpha()
        self.rect = self.image.get_rect()
...
class kar(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image = pygame.image.load(directory + "\\sprites\\car_p.png").convert_alpha()
        self.rect = self.image.get_rect()
        self.rect.x = 400
        self.rect.y = 400
...
class landscape(pygame.sprite.Sprite):
    ...
    def __init__(self, y):
        ...
        self.image = pygame.image.load(directory + "\\sprites\\mapa.png").convert_alpha()
        self.rect = self.image.get_rect() 
        self.rect.y = y
...
def scores():
    ...
    scoresOk = button(RED, 150, 450, 200, 25, "ATRÁS")
    scoresClear = button(RED, 450, 450, 200, 25, "LIMPIAR PUNTAJE")
    scoresTitle = myfont.render("PUNTAJE - TOP10", 1, WHITE, BLUE)
...
def instructions():
    ...
    label1 = myfont.render("- Maneja por la autopista, intenta no chocarte", 1, WHITE, BLUE)
    label2 = myfont.render("- Usa las teclas A y D del teclado para mover tú carro", 1, WHITE, BLUE)
    label3 = myfont.render("- Usa F para modo completo(en arreglo) :)", 1, WHITE, BLUE)
    label4 = myfont.render("- Atrapa todos los diamantes para conseguir puntos", 1, WHITE, BLUE)
...
def enterName():
    ...
    labelEnterName = myfont.render("INGRESE NOMBRE USUARIO:", 1, BLUE)
